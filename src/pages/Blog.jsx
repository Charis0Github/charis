    ...
    <div className="py-5 lg:px-0  w-full h-full mb-[5rem] flex flex-col leading-7">
      ...
      <div className="lg:px-[64px] px-5  w-full h-full mt-[2rem]">
        <h1 className="text-2xl font-bold">
          CALGI SECURELY DELIVERS YOUR NEEDS
        </h1>
        <p className="text-lg text-left my-[1rem] text-[#1111117f]">
          Access basic necessities at a cheaper rate, own your home on a rent to
          own basis or an outright payment, earn dividends when you invest into
          the cooperative, access loans at a 5% interest rate.
        </p>

        <h1 className="text-[#FD6602] text-2xl">FEATURES</h1>
        <p className="mt-3 text-[#1111117f]">
          1. Mortgage Loan maximum of N50,000,000 depending on the house type
          and location @ 6% interest rate To 25% per annum.
          <br />
          2. Equity contribution starts from 0% (depending on the proposed loan
          amount and building stage)
          <br />
          3. Equity Loan up to N4,000,000 after 6months of membership @ 5% per
          annum.
          <br />
          4. Maximum of thirty (30) years tenor5). Available to individuals of
          18 years and above.
          <br />
        </p>
        ...
        <p className="mt-3 text-[#1111117f]">
          1. Become a homeowner with ease at affordable and appreciable cost.
          <br />
          2. Long repayment tenor is subject to applicant’s age (up to 30 years
          repayment period)
          <br />
          3. Stable interest rate throughout the tenor of the loan.
          <br />
          4. Flexible and convenient monthly repayment to match the customer’s
          income.
          <br />
          5. Guarantee home payment support in case of death or disability or
          loss of income source.
          <br />
          6. Earn annual cashflow on your cooperative share capital.
          <br />
        </p>
      </div>
      ...
      <div className="w-full h-full flex flex-col bg-[#e6e4e4] py-10 mt-[3rem] leading-7">
        <div className="lg:px-[64px] px-5  w-full h-full">
          ...
          <li className="list-disc text-[#1111117f]">
            Buy an existing building any where in Edo state{" "}
          </li>
          <li className="list-disc text-[#1111117f]">
            Buy a building Off-Plan (about to be built on an estate)
          </li>
          <li className="list-disc text-[#1111117f]">
            Build your own house on your own land
          </li>
          <li className="list-disc text-[#1111117f]">
            Complete an uncompleted building
          </li>
          <li className="list-disc text-[#1111117f]">
            Renovate or upgrade an existing building
          </li>
        </div>
      </div>

      <div className="lg:px-[64px] px-5  w-full h-full mt-[2rem]">
        <h1 className="text-[#FD6602] text-2xl mt-[3rem]">
        ...
        <p className="mt-3 text-[#1111117f] w-full">
          ...
          <li className="list-disc text-[#1111117f]">
            Letter of Undertaking from applicant (Undertaking to have never
            accessed NHF Loan)
          </li>
